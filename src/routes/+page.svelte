...
{:else}
  ...
  <div class="flex flex-col justify-center items-center h-screen">
    <div class="w-3/5 mb-10">
        <h1 class="flex mb-4 font-extrabold leading-none tracking-tight text-blue-600 text-2xl ">locapark</h1>
        <div class="font-medium text-black rounded-lg content-start text-xl">{translate("description1")}</div>
    </div>
    
    <div class="w-3/5">
        <div class="font-medium text-black rounded-lg content-start text-lg mt-10 mx-10 mb-10"><i>{translate("mobile")}</i></div>
    </div>
